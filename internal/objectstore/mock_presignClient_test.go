...
func (_m *mockPresignClient) PresignGetObject(ctx context.Context, params *s3.GetObjectInput, optFns ...func(*s3.PresignOptions)) (*v4.PresignedHTTPRequest, error) {
...
func (_c *mockPresignClient_PresignGetObject_Call) Return(_a0 *v4.PresignedHTTPRequest, _a1 error) *mockPresignClient_PresignGetObject_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockPresignClient_PresignGetObject_Call) RunAndReturn(run func(context.Context, *s3.GetObjectInput, ...func(*s3.PresignOptions)) (*v4.PresignedHTTPRequest, error)) *mockPresignClient_PresignGetObject_Call {
	_c.Call.Return(run)
	return _c
}
