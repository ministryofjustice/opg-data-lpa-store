...
tail-logs: ## tails logs for lambda-create lambda-update lambda-get lambda-getlist lambda-getstatic apigw
	docker compose --ansi=always logs lambda-create lambda-update lambda-get lambda-getlist lambda-getstatic apigw -f
