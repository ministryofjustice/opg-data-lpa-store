...
func TestFieldWhenMissing(t *testing.T) {
	...
	var v string
	errors := Changes(changes).Field("/thing", &v)
...
func TestOptionalField(t *testing.T) {
	...
	var v string
	Changes(changes).OptionalField("/thing", &v)

	assert.Equal(t, "val", v)
}

func TestOptionalFieldWhenMissing(t *testing.T) {
	changes := []shared.Change{}

	var v string
	errors := Changes(changes).OptionalField("/thing", &v)

	assert.Empty(t, errors)
}

func TestOptionalFieldWhenWrongType(t *testing.T) {
	changes := []shared.Change{
		{Key: "/thing", New: json.RawMessage(`"val"`), Old: jsonNull},
	}
...
func TestValidatedField(t *testing.T) {
	...
	var v string
	Changes(changes).ValidatedField("/thing", &v, func() []shared.FieldError {
		return nil
	})
...
func TestValidatedFieldWhenInvalid(t *testing.T) {
	changes := []shared.Change{
		{Key: "/thing", New: json.RawMessage(`"what"`), Old: jsonNull},
	}

	var v string
	errors := Changes(changes).ValidatedField("/thing", &v, func() []shared.FieldError {
...
func TestValidatedFieldWhenMissing(t *testing.T) {
	changes := []shared.Change{}

	var v string
	errors := Changes(changes).ValidatedField("/thing", &v, func() []shared.FieldError { return nil })

	assert.Equal(t, []shared.FieldError{{Source: "/changes", Detail: "missing /thing"}}, errors)
}

func TestValidatedFieldWhenWrongType(t *testing.T) {
	changes := []shared.Change{
		{Key: "/thing", New: json.RawMessage(`"val"`), Old: jsonNull},
	}
